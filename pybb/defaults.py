...
PYBB_POST_LIST_SIZE = getattr(settings, 'PYBB_POST_LIST_SIZE', 20)
...
PYBB_DISABLE_POLLS = getattr(settings, 'PYBB_DISABLE_POLLS', False)
...
PYBB_TOPICS_DELETE_FORM = getattr(settings, 'PYBB_TOPICS_DELETE_FORM', 'pybb.forms.base.TopicsDeleteForm')
